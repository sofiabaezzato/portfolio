...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className='font-bold'>Hi, Sofia here!</span> I&apos;m a frontend enthusiast diving into the world of full-stack JavaScript. <span className="font-bold">My focus?</span> Crafting magic with <span className="underline">React</span> (<span className="underline">Next.js</span>)
      </motion.h1>
