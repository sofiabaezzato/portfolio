  ...
  return (
    isMobile() ? <MobileHeader /> : (
      ...
      <nav className='fixed flex top-[0.15rem] left-1/2 h-12 -translate-x-1/2 sm:h-[initial] sm:py-0'>
        <ul
          className='flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-10 dark:text-gray-200'
        >
          {links.map((link) => (
            <motion.li
